...
router.put('/changer-mot-de-passe',        authMiddleware, userCtrl.changerMotDePasse);
router.put('/changer-mot-de-passe-force',  authMiddleware, userCtrl.changerMotDePasseForce); // ← ajouté
